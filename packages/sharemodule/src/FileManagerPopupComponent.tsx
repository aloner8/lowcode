...
import { storageScopeQuery, useStorageScope } from './StorageScopeContext.js';
import {
  ChevronDown,
  ChevronRight,
  FileArchive,
...
export const FileManagerPopupComponent: React.FC<FileManagerPopupProps> = ({
  open, mode = 'full', title = 'File Manager', rootPath: rootPathProp = '/', currentPath: controlledPath,
  ...
  return <div className="modal d-block file-manager-popup-backdrop" tabIndex={-1} role="dialog" aria-modal="true">
    <div className={`modal-dialog ${mode === 'compact' ? 'modal-lg' : 'modal-xl'} modal-dialog-centered`}><div className="modal-content file-manager-popup shadow-lg border-0">
